<?php
    ...
    function capnhat_taikhoan($user, $pass, $email, $address, $tel, $anh, $id){
        $sql = "UPDATE taikhoan SET user='".$user."',pass='".$pass."',email='".$email."',address='".$address."',tel='".$tel."',anh='".$anh."' WHERE id = '".$id."'";
        pdo_query($sql);
    }
